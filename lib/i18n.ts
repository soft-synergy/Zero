...
export interface StepPageTranslations {
  ...
  age_insight_prefix: (decade: string, isMen: boolean) => string
  // BMI card page
  bmi_page_label: string
  // BMI card
...
const EN_STEP_PAGE: StepPageTranslations = {
  ...
  age_insight_prefix: (decade, isMen) => `${isMen ? 'Men' : 'Women'} in their ${decade}:`,
  // BMI card page
  bmi_page_label: 'Your Personal Summary',
  // BMI card
...
const stepPage: Record<LangCode, StepPageTranslations> = {
  ...
  lt: {
    ...EN_STEP_PAGE,
    bmi_page_label: 'Jūsų asmeninis apžvalga',
  ...
  lv: {
    ...EN_STEP_PAGE,
    bmi_page_label: 'Jūsu personīgais kopsavilkums',
  ...
  ro: {
    ...EN_STEP_PAGE,
    bmi_page_label: 'Rezumatul tău personal',
  ...
  cz: {
    ...EN_STEP_PAGE,
    bmi_page_label: 'Váš osobní přehled',
  ...
  dk: {
    ...EN_STEP_PAGE,
    bmi_page_label: 'Dit personlige resumé',
  ...
  gr: {
    ...EN_STEP_PAGE,
    bmi_page_label: 'Η προσωπική σου σύνοψη',
  ...
  hu: {
    ...EN_STEP_PAGE,
    bmi_page_label: 'Személyes összefoglalód',
  ...
  hr: {
    ...EN_STEP_PAGE,
    bmi_page_label: 'Vaš osobni sažetak',
  ...
  il: {
    ...EN_STEP_PAGE,
    bmi_page_label: 'הסיכום האישי שלך',
  ...
  ru: {
    ...EN_STEP_PAGE,
    bmi_page_label: 'Ваш личный итог',
  ...
  sk: {
    ...EN_STEP_PAGE,
    bmi_page_label: 'Váš osobný prehľad',
