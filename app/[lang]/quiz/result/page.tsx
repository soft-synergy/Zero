...
import { WEIGHT_STEP } from '@/lib/quiz-data'

const GOAL_WEIGHT_STEP = WEIGHT_STEP + 1  // step 12
...
export default function ResultPage() {
  ...
  const startWeight = Number(answers[WEIGHT_STEP]) || 200
  const goalWeight  = Number(answers[GOAL_WEIGHT_STEP]) || 160
